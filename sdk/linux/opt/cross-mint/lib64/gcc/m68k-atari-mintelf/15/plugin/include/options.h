...
#endif
#ifdef GENERATOR_FILE
extern const char *m68k_data_string;
#else
  const char *x_m68k_data_string;
#define m68k_data_string global_options.x_m68k_data_string
#endif
#ifdef GENERATOR_FILE
extern int m68k_lra_p;
#else
  int x_m68k_lra_p;
#define m68k_lra_p global_options.x_m68k_lra_p
#endif
#ifdef GENERATOR_FILE
extern const char *m68k_rodata_string;
#else
  const char *x_m68k_rodata_string;
#define m68k_rodata_string global_options.x_m68k_rodata_string
#endif
#ifdef GENERATOR_FILE
extern const char *m68k_text_string;
#else
  const char *x_m68k_text_string;
#define m68k_text_string global_options.x_m68k_text_string
#endif
#ifdef GENERATOR_FILE
...
#define MASK_FASTCALL (1U << 4)
#define MASK_ID_SHARED_LIBRARY (1U << 5)
#define MASK_LONG_JUMP_TABLE_OFFSETS (1U << 6)
#define MASK_RTD (1U << 7)
#define MASK_SHORT (1U << 8)
#define MASK_PCREL (1U << 9)
#define MASK_SEP_DATA (1U << 10)
#define MASK_STRICT_ALIGNMENT (1U << 11)
#define MASK_XGOT (1U << 12)
#define MASK_XTLS (1U << 13)
...
/* FASTCALL mask */
#define TARGET_FASTCALL ((target_flags & MASK_FASTCALL) != 0)
#define TARGET_FASTCALL_P(target_flags) (((target_flags) & MASK_FASTCALL) != 0)
#define TARGET_FASTCALL_OPTS_P(opts) (((opts->x_target_flags) & MASK_FASTCALL) != 0)
#define TARGET_EXPLICIT_FASTCALL_P(opts) ((opts->x_target_flags_explicit & MASK_FASTCALL) != 0)
#define SET_TARGET_FASTCALL(opts) opts->x_target_flags |= MASK_FASTCALL
...
enum opt_code
{
  ...
  OPT_list = 2038,                           /* -list */
  /* OPT_m5200 = 2039, */                    /* -m5200 */
  /* OPT_m5206e = 2040, */                   /* -m5206e */
  /* OPT_m528x = 2041, */                    /* -m528x */
  /* OPT_m5307 = 2042, */                    /* -m5307 */
  /* OPT_m5407 = 2043, */                    /* -m5407 */
  /* OPT_m68000 = 2044, */                   /* -m68000 */
  /* OPT_m68010 = 2045, */                   /* -m68010 */
  /* OPT_m68020 = 2046, */                   /* -m68020 */
  OPT_m68020_40 = 2047,                      /* -m68020-40 */
  OPT_m68020_60 = 2048,                      /* -m68020-60 */
  /* OPT_m68030 = 2049, */                   /* -m68030 */
  /* OPT_m68040 = 2050, */                   /* -m68040 */
  /* OPT_m68060 = 2051, */                   /* -m68060 */
  /* OPT_m68302 = 2052, */                   /* -m68302 */
  /* OPT_m68332 = 2053, */                   /* -m68332 */
  OPT_m68851 = 2054,                         /* -m68851 */
  OPT_m68881 = 2055,                         /* -m68881 */
  OPT_main = 2056,                           /* -main */
  OPT_main_ = 2057,                          /* -main= */
  OPT_malign_int = 2058,                     /* -malign-int */
  OPT_march_ = 2059,                         /* -march= */
  OPT_mbitfield = 2060,                      /* -mbitfield */
  /* OPT_mc68000 = 2061, */                  /* -mc68000 */
  /* OPT_mc68020 = 2062, */                  /* -mc68020 */
  /* OPT_mcfv4e = 2063, */                   /* -mcfv4e */
  /* OPT_mcpu32 = 2064, */                   /* -mcpu32 */
  OPT_mcpu_ = 2065,                          /* -mcpu= */
  OPT_mdata_ = 2066,                         /* -mdata= */
  OPT_mdiv = 2067,                           /* -mdiv */
  OPT_mfastcall = 2068,                      /* -mfastcall */
  OPT_mfidoa = 2069,                         /* -mfidoa */
  OPT_mhard_float = 2070,                    /* -mhard-float */
  OPT_mid_shared_library = 2071,             /* -mid-shared-library */
  OPT_mlong_jump_table_offsets = 2072,       /* -mlong-jump-table-offsets */
  OPT_mlra = 2073,                           /* -mlra */
  OPT_mnobitfield = 2074,                    /* -mnobitfield */
  OPT_mnofastcall = 2075,                    /* -mnofastcall */
  OPT_mnortd = 2076,                         /* -mnortd */
  OPT_mnoshort = 2077,                       /* -mnoshort */
  OPT_mpcrel = 2078,                         /* -mpcrel */
  OPT_mrodata_ = 2079,                       /* -mrodata= */
  OPT_mrtd = 2080,                           /* -mrtd */
  OPT_msep_data = 2081,                      /* -msep-data */
  OPT_mshared_library_id_ = 2082,            /* -mshared-library-id= */
  OPT_mshort = 2083,                         /* -mshort */
  OPT_msoft_float = 2084,                    /* -msoft-float */
  OPT_mstrict_align = 2085,                  /* -mstrict-align */
  OPT_mtext_ = 2086,                         /* -mtext= */
  OPT_mtune_ = 2087,                         /* -mtune= */
  OPT_mxgot = 2088,                          /* -mxgot */
  OPT_mxtls = 2089,                          /* -mxtls */
  OPT_n = 2090,                              /* -n */
  OPT_name_sort = 2091,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2092,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2093,              /* -no-integrated-cpp */
  OPT_no_pie = 2094,                         /* -no-pie */
  OPT_nocpp = 2095,                          /* -nocpp */
  OPT_nodefaultlibs = 2096,                  /* -nodefaultlibs */
  OPT_nolibc = 2097,                         /* -nolibc */
  OPT_nomain = 2098,                         /* -nomain */
  OPT_nophoboslib = 2099,                    /* -nophoboslib */
  OPT_nostartfiles = 2100,                   /* -nostartfiles */
  OPT_nostdinc = 2101,                       /* -nostdinc */
  OPT_nostdinc__ = 2102,                     /* -nostdinc++ */
  OPT_nostdlib = 2103,                       /* -nostdlib */
  OPT_nostdlib__ = 2104,                     /* -nostdlib++ */
  OPT_o = 2105,                              /* -o */
  OPT_objects = 2106,                        /* -objects */
  OPT_p = 2107,                              /* -p */
  OPT_pass_exit_codes = 2108,                /* -pass-exit-codes */
  /* OPT_pedantic = 2109, */                 /* -pedantic */
  OPT_pedantic_errors = 2110,                /* -pedantic-errors */
  OPT_pg = 2111,                             /* -pg */
  OPT_pie = 2112,                            /* -pie */
  OPT_pipe = 2113,                           /* -pipe */
  OPT_preprocess = 2114,                     /* -preprocess */
  OPT_print_file_name_ = 2115,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2116,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2117,          /* -print-multi-directory */
  OPT_print_multi_lib = 2118,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2119,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2120,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2121,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2122,               /* -print-prog-name= */
  OPT_print_search_dirs = 2123,              /* -print-search-dirs */
  OPT_print_sysroot = 2124,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2125,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2126,                    /* -print-value */
  OPT_quiet = 2127,                          /* -quiet */
  OPT_r = 2128,                              /* -r */
  OPT_remap = 2129,                          /* -remap */
  OPT_reverse_sort = 2130,                   /* -reverse-sort */
  OPT_s = 2131,                              /* -s */
  OPT_save_temps = 2132,                     /* -save-temps */
  OPT_save_temps_ = 2133,                    /* -save-temps= */
  OPT_shared = 2134,                         /* -shared */
  OPT_shared_libgcc = 2135,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2136,               /* -shared-libphobos */
  OPT_size_sort = 2137,                      /* -size-sort */
  /* OPT_specs = 2138, */                    /* -specs */
  OPT_specs_ = 2139,                         /* -specs= */
  OPT_static = 2140,                         /* -static */
  OPT_static_libasan = 2141,                 /* -static-libasan */
  OPT_static_libgcc = 2142,                  /* -static-libgcc */
  OPT_static_libgcobol = 2143,               /* -static-libgcobol */
  OPT_static_libgfortran = 2144,             /* -static-libgfortran */
  OPT_static_libgm2 = 2145,                  /* -static-libgm2 */
  OPT_static_libgo = 2146,                   /* -static-libgo */
  OPT_static_libhwasan = 2147,               /* -static-libhwasan */
  OPT_static_liblsan = 2148,                 /* -static-liblsan */
  OPT_static_libmpx = 2149,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2150,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2151,               /* -static-libphobos */
  OPT_static_libquadmath = 2152,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2153,               /* -static-libstdc++ */
  OPT_static_libtsan = 2154,                 /* -static-libtsan */
  OPT_static_libubsan = 2155,                /* -static-libubsan */
  OPT_static_pie = 2156,                     /* -static-pie */
  /* OPT_std_c__03 = 2157, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2158, */                /* -std=c++0x */
  OPT_std_c__11 = 2159,                      /* -std=c++11 */
  OPT_std_c__14 = 2160,                      /* -std=c++14 */
  OPT_std_c__17 = 2161,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2162, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2163, */                /* -std=c++1z */
  OPT_std_c__20 = 2164,                      /* -std=c++20 */
  OPT_std_c__23 = 2165,                      /* -std=c++23 */
  OPT_std_c__26 = 2166,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2167, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2168, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2169, */                /* -std=c++2c */
  OPT_std_c__98 = 2170,                      /* -std=c++98 */
  OPT_std_c11 = 2171,                        /* -std=c11 */
  OPT_std_c17 = 2172,                        /* -std=c17 */
  /* OPT_std_c18 = 2173, */                  /* -std=c18 */
  /* OPT_std_c1x = 2174, */                  /* -std=c1x */
  OPT_std_c23 = 2175,                        /* -std=c23 */
  /* OPT_std_c2x = 2176, */                  /* -std=c2x */
  OPT_std_c2y = 2177,                        /* -std=c2y */
  /* OPT_std_c89 = 2178, */                  /* -std=c89 */
  OPT_std_c90 = 2179,                        /* -std=c90 */
  OPT_std_c99 = 2180,                        /* -std=c99 */
  /* OPT_std_c9x = 2181, */                  /* -std=c9x */
  OPT_std_f2003 = 2182,                      /* -std=f2003 */
  OPT_std_f2008 = 2183,                      /* -std=f2008 */
  OPT_std_f2008ts = 2184,                    /* -std=f2008ts */
  OPT_std_f2018 = 2185,                      /* -std=f2018 */
  OPT_std_f2023 = 2186,                      /* -std=f2023 */
  OPT_std_f202y = 2187,                      /* -std=f202y */
  ...
  OPT_std_gnu__26 = 2199,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2200, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2201, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2202, */              /* -std=gnu++2c */
  ...
  OPT_std_gnu23 = 2208,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2209, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2210,                      /* -std=gnu2y */
  /* OPT_std_gnu89 = 2211, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2212,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2213,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2214, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2215, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2216,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2217, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2218, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2219, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2220, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2221, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2222, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2223,                     /* -std=legacy */
  OPT_stdlib_ = 2224,                        /* -stdlib= */
  OPT_symbol_ = 2225,                        /* -symbol= */
  OPT_symbolic = 2226,                       /* -symbolic */
  OPT_t = 2227,                              /* -t */
  OPT_time = 2228,                           /* -time */
  OPT_time_ = 2229,                          /* -time= */
  OPT_traditional = 2230,                    /* -traditional */
  OPT_traditional_cpp = 2231,                /* -traditional-cpp */
  OPT_tree_stats = 2232,                     /* -tree-stats */
  OPT_trigraphs = 2233,                      /* -trigraphs */
  OPT_truncate = 2234,                       /* -truncate */
  OPT_type_stats = 2235,                     /* -type-stats */
  OPT_u = 2236,                              /* -u */
  OPT_undef = 2237,                          /* -undef */
  OPT_v = 2238,                              /* -v */
  OPT_version = 2239,                        /* -version */
  OPT_w = 2240,                              /* -w */
  OPT_wrapper = 2241,                        /* -wrapper */
  OPT_x = 2242,                              /* -x */
  OPT_z = 2243,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
