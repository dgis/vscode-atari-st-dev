 ...
 * the Free Software Foundation; either version 2, or (at your option)n * any later version.
 *
...
#define Fpipe(a) (long)trap_1_wl(0x100,(long)(a))
...
#define Pvfork() (long)trap_1_w_noclobber(0x113)
...
#define Prusage(a) (long)trap_1_wl(0x11e,(long)(a))
...
#define NSetinterrupt(a,b,c) (long)trap_14_wwwl(0x87,(short)(a),(short)(b),(long)(c))
